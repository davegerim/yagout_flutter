...
class _PaymentLinkScreenState extends State<PaymentLinkScreen> {
  ...
  final _expiryDateController = TextEditingController(text: '2025-12-31');
  ...
  final _failureUrlController =
      TextEditingController(text: 'https://httpbin.org/status/200');
  ...
  void initState() {
    ...
    _orderIdController.text =
        YagoutPayService.generateUniqueOrderId('PAYMENT_LINK');
  }
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            const Text('Payment Link has been created successfully.'),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Payment Link API'),
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        'Generate a dynamic payment link for customers to make payments.',
                      ...
                      Container(
                        ...
                        child: const Row(
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                'This will create a payment link that customers can use to make payments.',
                                style:
